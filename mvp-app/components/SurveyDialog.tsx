...
export function SurveyDialog({ onClose }: SurveyDialogProps) {
    ...
    if (submitted) {
        return (
            <div className="fixed inset-0 z-[200] flex items-center justify-center px-6 bg-bg-overlay animate-in fade-in duration-300">
                <div className="bg-white w-full max-w-[340px] rounded-[24px] p-8 flex flex-col items-center text-center shadow-2xl relative">
                    <button
                        onClick={onClose}
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center px-6 bg-bg-overlay animate-in fade-in duration-300">
            ...
            <div className="relative bg-white w-full max-w-[360px] rounded-[24px] overflow-hidden shadow-2xl flex flex-col pt-8 px-6 pb-6">
                <button
                    onClick={onClose}
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-[14px] font-medium text-accent-blue bg-accent-blue/5 py-2 px-4 rounded-full inline-block">
                        {t('intro')}
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-3">
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        rating === num
                                            ...
                                            : "bg-bg-page text-text-muted border-[#E0E0E0] hover:border-accent-orange hover:text-accent-orange"
                                    )}
                                >
                                    {num}
                                </button>
                        ...
                        <div className={cn(
                            ...
                            <textarea
                                ...
                                className="w-full h-full p-3 rounded-xl bg-bg-page border border-border text-[14px] text-text-primary outline-none focus:border-accent-blue transition-colors resize-none"
                            />
                        </div>
                    </div>
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className={cn(
                                    ...
                                    refer === true
                                        ...
                                        : "bg-white text-text-primary border-[#E0E0E0]"
                                )}
                            >
                                {t('yes')}
                            </button>
                            <button
                                ...
                                className={cn(
                                    "flex-1 h-[48px] rounded-xl text-[14px] font-bold border transition-all active:scale-95",
                                    refer === false
                                        ? "bg-text-muted text-white border-transparent"
                                        : "bg-white text-text-primary border-[#E0E0E0]"
                                )}
                            >
                                {t('no')}
                    ...
                    <div className="mt-2 flex gap-3">
                        <button
                            onClick={onClose}
                            className="flex-1 h-[52px] rounded-2xl text-[15px] font-bold text-[#888888] active:scale-95 transition-all"
                        >
                            {t('no')}
                        </button>
                        <button
                            ...
                            className={cn(
                                ...
                                canSubmit
                                    ...
                                    : "bg-[#F5F5F5] text-[#BBBBBB] cursor-not-allowed"
                            )}
                        >
                            {t('submit')}
                        </button>
